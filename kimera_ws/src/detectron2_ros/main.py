...
categories = ['wall', 'floor', 'ceiling', 'chair', 'table', 'door', 'window', 'curtain',
              'picture', 'mirror', 'bed', 'bench', 'sofa', 'pillow', 'monitor', 'pc',
              'sink', 'plant', 'cabinet', 'trashcan', 'carpet', 'toilet', 'bathtub',
              'microwave', 'refrigerator', 'oven', 'object']
