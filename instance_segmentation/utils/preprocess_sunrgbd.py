...
from utils.sun.data_handler import load_data, plot_statistics, get_statistics, save_annotations, sort_dictionary
...
def main():
    ...
    parser.add_argument('-dp', '--data-path', type=str, default="./datasets/SUNRGBD/",
                        help='Training and validation sets paths')

    parser.add_argument('-ja', '--json-annotations', type=str, default='**/annotation2Dfinal/*.json',
                        help='JSON annotations extension')

    parser.add_argument('-ri', '--rgb-images', type=str, default='**/image/*.jpg',
    ...
    # check_images_quality(images_list)
...
def check_images_quality(images_list):
